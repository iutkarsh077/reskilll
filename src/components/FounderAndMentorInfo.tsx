...
const FounderAndMentorInfo = () => {
  return (
    <div className="w-full pt-6 dark:bg-black">
      ...
      <div className="flex justify-around pt-10">
        ...
        <div className="flex justify-center flex-col items-center gap-y-2">
          <Image
            ...
            className="p-1"
          />
          <div className="dark:text-white">Ex-Microsoft, Software Engineer</div>
        </div>
        <div className="flex justify-center flex-col items-center gap-y-3">
         <FcGoogle className="text-4xl"/>
          <div className="dark:text-white">Google SPS, India </div>
        </div>
      </div>
    </div>
  );
